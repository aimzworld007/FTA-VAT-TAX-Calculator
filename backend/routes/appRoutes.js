...
r.get('/vat-records/:id', asyncHandler(c.getVat)); r.put('/vat-records/:id', asyncHandler(c.updateVat)); r.delete('/vat-records/:id', asyncHandler(c.deleteVat));
r.get('/corporate-tax-records', asyncHandler(c.listTax)); r.post('/corporate-tax-records', asyncHandler(c.createTax));
r.get('/corporate-tax-records/:id', asyncHandler(c.getTax)); r.put('/corporate-tax-records/:id', asyncHandler(c.updateTax)); r.delete('/corporate-tax-records/:id', asyncHandler(c.deleteTax));
