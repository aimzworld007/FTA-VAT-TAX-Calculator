...
r.get('/reminders', asyncHandler(c.listReminders)); r.post('/reminders', asyncHandler(c.createReminder)); r.put('/reminders/:id', asyncHandler(c.updateReminder)); r.delete('/reminders/:id', asyncHandler(c.deleteReminder)); r.patch('/reminders/:id/complete', asyncHandler(c.completeReminder));
