...
export function TaxDashboard() {
  ...
  return <Box sx={{ minHeight: '100vh', pb: { xs: 12, md: 0 }, background: 'linear-gradient(180deg, #eef4ff 0%, #F6F8FB 180px, #F6F8FB 100%)' }}><Header onOpenDrawer={() => setDrawerOpen(true)} onGoHome={() => setM('home')} />
